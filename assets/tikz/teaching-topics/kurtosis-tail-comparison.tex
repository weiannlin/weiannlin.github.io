...
\begin{tikzpicture}[
  ...
  % Sample segments 0.5cm long per spec 1.9, from x = 0.52 to x = 1.02.
  ...
  \node[anchor=west, inner sep=0pt] at ([yshift=2.58cm]2.60,0)
    {$\alpha_{\sssig 4}$};

  \draw[laplacecurve] ([yshift=2.16cm]0.52,0) -- ([yshift=2.16cm]1.02,0);
  \node[anchor=west, inner sep=0pt] at ([yshift=2.16cm]1.15,0) {Laplace};
  \node[anchor=west, inner sep=0pt] at ([yshift=2.16cm]2.60,0) {$6$};

  \draw[normalcurve] ([yshift=1.74cm]0.52,0) -- ([yshift=1.74cm]1.02,0);
  \node[anchor=west, inner sep=0pt] at ([yshift=1.74cm]1.15,0) {normal};
  \node[anchor=west, inner sep=0pt] at ([yshift=1.74cm]2.60,0) {$3$};

  \draw[uniformcurve] ([yshift=1.32cm]0.52,0) -- ([yshift=1.32cm]1.02,0);
  \node[anchor=west, inner sep=0pt] at ([yshift=1.32cm]1.15,0) {uniform};
  \node[anchor=west, inner sep=0pt] at ([yshift=1.32cm]2.60,0) {$9/5$};
\end{tikzpicture}
\end{document}
