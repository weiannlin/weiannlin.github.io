...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0,0)}]
    ...
    \node[journalink] at (0.3,-1.05) {$\mathbb{P}(A\cup B)$};
  ...
  \begin{scope}[shift={(2.8,0)}]
    ...
    \draw[journalink, line width=0.8pt] \circleA;
    \draw[journalink, line width=0.8pt] \circleB;
    \node[journalink] at (0.3,-1.05) {$\mathbb{P}(A)$};
    \node[journalink] at (1.7,0) {$+$};
  \end{scope}
  ...
  \begin{scope}[shift={(5.6,0)}]
    ...
    \draw[journalink, line width=0.8pt] \circleA;
    \draw[journalink, line width=0.8pt] \circleB;
    \node[journalink] at (0.3,-1.05) {$\mathbb{P}(B)$};
    \node[journalink] at (1.7,0) {$-$};
  \end{scope}
  ...
  \begin{scope}[shift={(8.4,0)}]
    ...
    \draw[journalink, line width=0.8pt] \circleA;
    \draw[journalink, line width=0.8pt] \circleB;
    \node[journalink] at (0.3,-1.05) {$\mathbb{P}(A\cap B)$};
  \end{scope}
\end{tikzpicture}
\end{document}
