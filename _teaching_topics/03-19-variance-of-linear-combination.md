...
$$
\begin{aligned}
\mathrm{Var}\Bigl(&\sum_{i=1}^{n}a_i\,X_i\Bigr) =\sum_{i=1}^{n}a_i^{2}\,\mathrm{Var}(X_i)\\[0.2em]
...
&=\operatorname{Cov}\Bigl(\sum_{i=1}^{n}a_i\,X_i,\ \sum_{i=1}^{n}a_i\,X_i\Bigr)\\[0.45em]
&=\sum_{i=1}^{n}\operatorname{Cov}(a_i\,X_i,\,a_i\,X_i)\\[0.2em]
&\qquad+\mathop{\sum\sum}\limits_{i\neq j}\operatorname{Cov}(a_i\,X_i,\,a_j\,X_j)\\[0.45em]
&=\sum_{i=1}^{n}a_i^{2}\,\mathrm{Var}(X_i)\\[0.2em]
&\qquad+2\mathop{\sum\sum}\limits_{i<j}a_ia_j\,\operatorname{Cov}(X_i,X_j)
\end{aligned}
$$
...
&=\frac{1}{\,n^{2}\,}\sum_{i=1}^{n}\mathrm{Var}(X_i)=\frac{\,\sigma_{\sssig X}^{2}\,}{n}
\end{aligned}
$$
...
$$
\begin{aligned}
\operatorname{Cov}(X_i,X_j)&=\mathbb{E}(X_iX_j)-\mathbb{E}(X_i)\,\mathbb{E}(X_j)\\[0.45em]
&=q-p^{2}
\end{aligned}
$$
...
$$
\begin{aligned}
\mathrm{Var}(&X_1+\cdots+X_n) =\sum_{i=1}^{n}\mathrm{Var}(X_i)\\[0.2em]
...
\begin{aligned}
\operatorname{Cov}(X_i,\overline{X})&=\operatorname{Cov}\biggl[\,X_i,\ \frac{1}{\,n\,}(X_1+\cdots+X_n)\,\biggr]\\[0.45em]
&=\frac{1}{\,n\,}\Bigl[\,\operatorname{Cov}(X_i,X_1)+\cdots\\[0.2em]
&\qquad +\operatorname{Cov}(X_i,X_i)+\cdots\\[0.2em]
&\qquad +\operatorname{Cov}(X_i,X_n)\,\Bigr]\\[0.45em]
&=\frac{1}{\,n\,}\Bigl[\,0+\cdots+\mathrm{Var}(X_i)+\cdots+0\,\Bigr]\\[0.2em]
&=\frac{\,\sigma^{2}\,}{\,n\,}
\end{aligned}
$$
...
$$
\mathbb{E}(X_i\,X_j)=\frac{\,M(M-1)\,}{N(N-1)}
$$
...
&=\sum_{i=1}^{n}\mathbb{E}(X_i)=n\,\frac{\,M\,}{N}
\end{aligned}
$$
...
&=\sum_{i=1}^{n}\mathrm{Var}(X_i)\\[0.2em]
&\qquad+2\mathop{\sum\sum}\limits_{i<j}\operatorname{Cov}(X_i,X_j)\\[0.45em]
&=n\,\frac{\,M\,}{N}\,\frac{\,(N-M)\,}{N}\\[0.2em]
&\qquad+n(n-1)\,\biggl[\,\frac{\,M(M-1)\,}{N(N-1)}\\[0.2em]
&\qquad -\frac{\,M^{2}\,}{N^{2}}\,\biggr]\\[0.45em]
&=n\,\frac{\,M\,}{N}-n\,\frac{\,M^{2}\,}{N^{2}}\\[0.2em]
&\qquad+n(n-1)\,\frac{\,M(M-1)\,}{N(N-1)}\\[0.2em]
&\qquad-n^{2}\,\frac{\,M^{2}\,}{N^{2}}+n\,\frac{\,M^{2}\,}{N^{2}}\\[0.45em]
&=n\,\frac{\,M\,}{N}\,\biggl[1+(n-1)\,\frac{\,(M-1)\,}{(N-1)}\\[0.2em]
&\qquad -n\,\frac{\,M\,}{N}\biggr]\\[0.45em]
&=n\,\frac{\,M\,}{N}\times\\[0.2em]
&\ \ \frac{\,\begin{aligned}N(N-1)&+(n-1)N(M-1)\\[0.1em] &-\,nM(N-1)\end{aligned}\,}{N(N-1)}\\[0.45em]
&=n\,\frac{\,M\,}{N}\,\frac{\,N^{2}-MN-nN+nM\,}{N(N-1)}\\[0.45em]
&=n\,\frac{\,M\,}{N}\,\frac{\,(N-M)(N-n)\,}{N(N-1)}\\[0.45em]
&=n\,\frac{\,M\,}{N}\,\biggl(1-\frac{\,M\,}{N}\biggr)\,\biggl(\frac{\,N-n\,}{N-1}\biggr)
\end{aligned}
$$
