...
**Proof.** 由 [Definition 2.7](#def-variance) 與 [Theorem 2.10](/teaching-topics/properties-of-expectation/#thm-expectation-linearity) 可知
...
\begin{aligned}
&\mathbb{E}\bigl(X^{2}\bigr)=\sum_{x=3}^{6}x^{2}\,\mathbb{P}(X=x)\\[0.45em]
&\quad =3^{2}\times0.2+4^{2}\times0.3+5^{2}\times0.3+6^{2}\times0.2\\[0.45em]
&\quad =21.3
\end{aligned}
$$
