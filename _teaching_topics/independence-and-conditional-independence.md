...
**Proof.** **(1)** 由 $A\indep B$ 可知 $\mathbb{P}(A\cap B)=\mathbb{P}(A)\,\mathbb{P}(B)$ 成立。
...
$$
\begin{aligned}
&\mathbb{P}(A^{\prime}\cap B^{\prime})\\[0.4em]
&\quad=1-\mathbb{P}(A\cup B)\\[0.4em]
&\quad=1-\big[\mathbb{P}(A)+\mathbb{P}(B)-\mathbb{P}(A\cap B)\big]\\[0.4em]
&\quad=1-\mathbb{P}(A)-\mathbb{P}(B)+\mathbb{P}(A)\,\mathbb{P}(B)\\[0.4em]
&\quad=\big[1-\mathbb{P}(A)\big]\big[1-\mathbb{P}(B)\big]\\[0.4em]
&\quad=\mathbb{P}(A^{\prime})\,\mathbb{P}(B^{\prime})
\end{aligned}
$$
...
&\quad=\mathbb{P}(A\mid C)=\mathbb{P}(A)\\[0.4em]
&\mathbb{P}(B\mid A,C)=\mathbb{P}(B\mid A)\\[0.4em]
&\quad=\mathbb{P}(B\mid C)=\mathbb{P}(B)\\[0.4em]
&\mathbb{P}(C\mid A,B)=\mathbb{P}(C\mid A)\\[0.4em]
&\quad=\mathbb{P}(C\mid B)=\mathbb{P}(C)
\end{aligned}
$$
...
$$
\begin{aligned}
&\mathbb{P}\big(A_1\cup(A_2\cap A_3)\big)\\[0.4em]
&\quad=1-\mathbb{P}(A_1^{\prime})\big(1-\mathbb{P}(A_2\cap A_3)\big)\\[0.4em]
&\quad=1-0.1\times(1-0.81)=0.981
\end{aligned}
$$
...
$$
\begin{aligned}
&\mathbb{P}(A_2\cap A_3)\\[0.4em]
&\quad=\mathbb{P}(A_2)+\mathbb{P}(A_3)-\mathbb{P}(A_2\cup A_3)\\[0.4em]
&\quad=0.9+0.9-0.96=0.84
\end{aligned}
$$
