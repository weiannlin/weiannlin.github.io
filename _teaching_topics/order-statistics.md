...
$$
\begin{aligned}
&\mathbb{P}(X_1>X_2\mid X_1>X_3)\\[0.45em]
&\quad =\frac{\,\mathbb{P}\bigl(\lbrace X_1>X_2\rbrace\cap\lbrace X_1>X_3\rbrace\bigr)\,}{\mathbb{P}(X_1>X_3)}
\end{aligned}
$$
...
\begin{aligned}
&\mathbb{P}(X_1>X_2\mid X_1<X_3)\\[0.45em]
&\quad =\frac{\,\mathbb{P}(X_3>X_1>X_2)\,}{\mathbb{P}(X_1<X_3)}
\end{aligned}
$$
