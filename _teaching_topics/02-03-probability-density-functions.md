...
\dfrac{dF_{\sssig X}(x)}{dx}, & \text{$x$ 是 $\mathcal{R}_{\sssig X}$ 中的可微分點}\\[0.8em]
...
<div class="topic-cases">
  ...
  <div class="topic-cases__rows">
    <div class="topic-cases__val">$\dfrac{dF_{\sssig X}(x)}{dx},$</div>
    <div class="topic-cases__cond">$x$ 是 $\mathcal{R}_{\sssig X}$ 中的可微分點</div>
    <div class="topic-cases__val">$0,$</div>
    <div class="topic-cases__cond">$x$ 是 $\mathcal{R}_{\sssig X}$ 中的不可微分點或不在 $\mathcal{R}_{\sssig X}$ 中</div>
  </div>
</div>
...
&=c\left[2x^{2}-\frac{2}{3}x^{3}\right]_{0}^{2}=\frac{8}{3}c\qquad\therefore\, c=\frac{3}{8}
\end{aligned}
$$
...
$$
\begin{aligned}
\mathbb{P}\bigl(&Y\geqslant2+2\sqrt{2}\ \text{or}\\[0.4em]
&\qquad Y\leqslant2-2\sqrt{2}\bigr)\\[0.4em]
...
&\qquad\int_{-\infty}^{\infty}\frac{1}{\sqrt{2\pi\cdot6}}\,e^{-\frac{(x-3)^{2}}{12}}\,dx\\[0.45em]
&=c\sqrt{2\pi\cdot6}
\end{aligned}
$$
...
&=c\cdot\mathcal{B}(2,2)=c\,\frac{\Gamma(2)\Gamma(2)}{\Gamma(2+2)}=c\,\frac{1!\cdot1!}{3!}\qquad\therefore\, c=6
\end{aligned}
$$
...
&=c\,\frac{1!\cdot1!}{3!}\qquad\therefore\, c=6
\end{aligned}
$$
