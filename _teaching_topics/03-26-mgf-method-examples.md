...
&=\frac{1}{\,2^{3}\Gamma(3)\,}x^{3-1}e^{\frac{-x}{2}}\times\frac{1}{\,3^{2}\Gamma(2)\,}y^{2-1}e^{\frac{-y}{3}}\\[0.45em]
&=\frac{1}{\,2^{3}\Gamma(3)3^{2}\Gamma(2)\,}x^{3-1}y^{2-1}e^{\frac{-x}{2}+\frac{-y}{3}},\\[0.25em]
&\quad x,y>0
\end{aligned}
$$
...
\begin{aligned}
f_{\sssig UV}(u,v)&=f_{\sssig XY}\Bigl(\frac{u(1-v)}{3},\frac{uv}{2}\Bigr)\lvert\mathbf{J}\rvert\\[0.45em]
&=\frac{1}{\,2^{3}\Gamma(3)3^{2}\Gamma(2)\,}\biggl[\frac{u(1-v)}{3}\biggr]^{3-1}\\[0.25em]
&\qquad\biggl[\frac{uv}{2}\biggr]^{2-1}e^{\frac{-\frac{u(1-v)}{3}}{2}+\frac{-\frac{uv}{2}}{3}}\biggl\lvert\frac{u}{6}\biggr\rvert\\[0.45em]
&=\frac{1}{\,6^{5}\Gamma(2+3)\,}u^{5-1}e^{\frac{-u}{6}}\\[0.25em]
&\qquad\times\frac{\Gamma(2+3)}{\,\Gamma(2)\Gamma(3)\,}v^{2-1}(1-v)^{3-1},\\[0.25em]
&\quad u>0,\ 0<v<1
\end{aligned}
$$
...
\begin{aligned}
f_{\sssig UV}(u,v)&=f_{\sssig X_1X_2}(v,u-v)\lvert\mathbf{J}\rvert\\[0.45em]
&=1\times\lvert-1\rvert=1,\\[0.25em]
&\quad 0<u<2,\ 0<v<1,\\[0.25em]
&\quad v<u,\ 0<u-v<1
\end{aligned}
$$
...
&=\int^{u}_{0}\int_{0}^{u-x_2}f_{\sssig X_1X_2}(x_1,x_2)\,dx_1\,dx_2\\[0.45em]
&=\int_{0}^{u}\int_{0}^{u-x_2}1\,dx_1\,dx_2\\[0.45em]
&=\int_{0}^{u}(u-x_2)\,dx_2\\[0.45em]
&=\left[ux_2-\frac{1}{2}x_2^{2}\right]^{u}_{0}=\frac{u^{2}}{2},\\[0.25em]
&\quad 0<u<1
\end{aligned}
$$
...
&=1-\int_{u-1}^{1}\int_{u-x_2}^{1}f_{\sssig X_1X_2}(x_1,x_2)\,dx_1\,dx_2\\[0.45em]
&=1-\int_{u-1}^{1}\int_{u-x_2}^{1}1\,dx_1\,dx_2\\[0.45em]
&=1-\int_{u-1}^{1}(1-u+x_2)\,dx_2\\[0.45em]
&=1-\left[x_2-ux_2+\frac{1}{2}x_2^{2}\right]^{1}_{u-1}\\[0.45em]
&=-\frac{1}{2}u^{2}+2u-1,\ \ 1\leqslant u<2
\end{aligned}
$$
...
$$
X_i=e^{\frac{-W_i}{2}}\qquad\therefore\, \mathbf{J}=\frac{d\,x_i}{d\,w_i}=-\frac{1}{2}e^{-\frac{\,w_i\,}{2}}
$$
...
&=1\times\biggl\lvert-\frac{1}{2}e^{-\frac{\,w_i\,}{2}}\biggr\rvert\\[0.45em]
&=\frac{1}{2}e^{-\frac{\,w_i\,}{2}},\ \ w_i>0
\end{aligned}
$$
...
&=\mathbb{P}(X_1\leqslant x,\ldots,X_n\leqslant x)\\[0.45em]
&=\mathbb{P}(X_1\leqslant x)\,\mathbb{P}(X_2\leqslant x)\cdots\mathbb{P}(X_n\leqslant x)\\[0.25em]
&\quad \bigl[\ \because X_1,\ldots,X_n\ \text{獨立}\ \bigr]\\[0.45em]
&=F_{\sssig X_1}(x)\,F_{\sssig X_2}(x)\cdots F_{\sssig X_n}(x)\\[0.25em]
