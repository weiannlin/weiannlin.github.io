...
&=\mathbb{P}\bigl(g_1(X_1,X_2)=y_1,\\[0.2em]
&\qquad\qquad g_2(X_1,X_2)=y_2\bigr)\\[0.45em]
&=\mathbb{P}\bigl(X_1=h_1(y_1,y_2),\\[0.2em]
&\qquad\qquad X_2=h_2(y_1,y_2)\bigr)\\[0.45em]
&=p_{\sssig X_1X_2}\bigl(h_1(y_1,y_2),h_2(y_1,y_2)\bigr)
\end{aligned}
$$
...
$$
\Longrightarrow\ X_1=h_1(Y_1,Y_2),\ X_2=h_2(Y_1,Y_2)
$$
...
$$
\begin{aligned}
&\Longrightarrow X_1=h_1(Y_1,Y_2),\\[0.2em]
...
&\mathbb{E}\bigl(\bar{X}^{2}\bigr)=(0)^{2}\times\frac{1}{\,8\,}+\Bigl(\frac{1}{\,3\,}\Bigr)^{2}\times\frac{3}{\,8\,}+\Bigl(\frac{2}{\,3\,}\Bigr)^{2}\times\frac{3}{\,8\,}+(1)^{2}\times\frac{1}{\,8\,}=\frac{1}{\,3\,}
\end{aligned}
$$
...
&\qquad +\Bigl(\frac{2}{\,3\,}\Bigr)^{2}\times\frac{3}{\,8\,}+(1)^{2}\times\frac{1}{\,8\,}=\frac{1}{\,3\,}
\end{aligned}
$$
...
&\quad \text{with }x_1=0,1,2,\ x_2=0,1,2
\end{aligned}
$$
...
\begin{aligned}
p_{\sssig Y_1Y_2}(y_1,y_2)&=\mathbb{P}(Y_1=y_1,Y_2=y_2)\\[0.45em]
&=\mathbb{P}(X_1+X_2=y_1,X_1-X_2=y_2)\\[0.45em]
&=\mathbb{P}\Bigl(X_1=\frac{y_1+y_2}{2},X_2=\frac{y_1-y_2}{2}\Bigr)\\[0.45em]
&=p_{\sssig X_1X_2}\Bigl(\frac{y_1+y_2}{2},\frac{y_1-y_2}{2}\Bigr)\\[0.45em]
&=p^{\frac{y_1+y_2}{2}+\frac{y_1-y_2}{2}}(1-p)^{4-\frac{y_1+y_2}{2}-\frac{y_1-y_2}{2}}\\[0.45em]
&=p^{y_1}(1-p)^{4-y_1},\\[0.45em]
...
$$
Z=X+Y,\ W=X\qquad\therefore\, X=W,\ Y=Z-W
$$
...
$$
\begin{aligned}
&\Longrightarrow\ f_{\sssig ZW}(z,w)\\[0.45em]
&=24w(z-w)\cdot\bigl\lvert-1\bigr\rvert\\[0.45em]
&=24w(z-w),\\[0.2em]
...
$$
\begin{aligned}
&\Longrightarrow\ \ f_{\sssig X}(x)\\[0.2em]
&=\int_{-\infty}^{\infty}f_{\sssig XY}(x,y)\,dy\\[0.2em]
&=\frac{1}{\,\sqrt{2\pi}\,}e^{-\frac{\,x^{2}\,}{2}},\ -\infty<x<\infty\\[0.9em]
f_{\sssig Y}(y)&=\int_{-\infty}^{\infty}f_{\sssig XY}(x,y)\,dx\\[0.2em]
&=\frac{1}{\,\sqrt{2\pi}\,}e^{-\frac{\,y^{2}\,}{2}},\ -\infty<y<\infty
\end{aligned}
$$
...
$$
\begin{aligned}
f_{\sssig Z_1Z_2}(z_1,z_2)&=f_{\sssig U_1U_2}\Bigl(e^{-\frac{1}{\,2\,}(z_1^{2}+z_2^{2})},\\[0.2em]
...
$$
\begin{aligned}
&\Longrightarrow\ \ f_{\sssig Z_1}(z_1)\\[0.2em]
&=\int_{-\infty}^{\infty}f_{\sssig Z_1Z_2}(z_1,z_2)\,dz_2\\[0.2em]
&=\frac{1}{\,\sqrt{2\pi}\,}e^{-\frac{\,z_1^{2}\,}{2}},\ -\infty<z_1<\infty\\[0.9em]
f_{\sssig Z_2}(z_2)&=\int_{-\infty}^{\infty}f_{\sssig Z_1Z_2}(z_1,z_2)\,dz_1\\[0.2em]
&=\frac{1}{\,\sqrt{2\pi}\,}e^{-\frac{\,z_2^{2}\,}{2}},\ -\infty<z_2<\infty
\end{aligned}
$$
