...
\begin{aligned}
\mathbb{E}(Y\mid X=x)&=\mu_{\sssig Y}+\rho_{\sssig XY}\frac{\,\sigma_{\sssig Y}\,}{\sigma_{\sssig X}}(x-\mu_{\sssig X})\\[0.55em]
\text{或是}\ \ \mathbb{E}(X\mid Y=y)&=\mu_{\sssig X}+\rho_{\sssig XY}\frac{\,\sigma_{\sssig X}\,}{\sigma_{\sssig Y}}(y-\mu_{\sssig Y})
\end{aligned}
$$
...
$$
\begin{aligned}
\text{又}\ \ \mathbb{E}(XY)&=\mathbb{E}\bigl[\mathbb{E}(XY\mid X)\bigr]=\mathbb{E}\bigl[X\mathbb{E}(Y\mid X)\bigr]\\[0.45em]
&=\mathbb{E}\bigl(\beta_0X+\beta_1X^{2}\bigr)\\[0.45em]
&=\beta_0\mathbb{E}(X)+\beta_1\mathbb{E}\bigl(X^{2}\bigr)\\[0.45em]
&=\beta_0\mathbb{E}(X)+\beta_1\Bigl(\mathrm{Var}(X)+\bigl[\mathbb{E}(X)\bigr]^{2}\Bigr)
\end{aligned}
$$
...
$$
\beta_1\cdot\alpha_1=\rho_{\sssig XY}\frac{\,\sigma_{\sssig Y}\,}{\sigma_{\sssig X}}\cdot\rho_{\sssig XY}\frac{\,\sigma_{\sssig X}\,}{\sigma_{\sssig Y}}=\rho^{2}_{\sssig XY}
$$
...
&=\operatorname{sgn}(\alpha_1)\sqrt{\beta_1\cdot\alpha_1}
\end{aligned}
$$
...
$$
\begin{aligned}
\rho^{2}_{\sssig XY}&=(-1.5)\times(-0.54)=0.81
\end{aligned}
$$
...
$$
\begin{aligned}
\rho^{2}_{\sssig XY}&=(-1.5)\times(-0.54)=0.81\qquad\therefore\, \lvert\rho_{\sssig XY}\rvert=\sqrt{0.81}=0.9
\end{aligned}
$$
...
\text{故}\quad\frac{\,\sigma_{\sssig Y}\,}{\sigma_{\sssig X}}&=\frac{0.25}{\,0.65\,}=\frac{5}{\,13\,}\qquad\therefore\, \frac{\,\mathrm{Var}(Y)\,}{\mathrm{Var}(X)}=\frac{5^{2}}{\,13^{2}\,}=\frac{25}{\,169\,}
\end{aligned}
$$
...
&=22.5+0.25\,\mathbb{E}(X)\qquad\therefore\, \mathbb{E}(Y)=65
\end{aligned}
$$
...
&\quad y=1,2,\ldots,x,\ \ x=1,2,\ldots,n
\end{aligned}
$$
...
&=\frac{1}{\,n-y+1\,}\frac{\,(y+n)(n-y+1)\,}{2}\\[0.45em]
&=\frac{\,y\,}{2}+\frac{\,n\,}{\,2\,},\ y=1,\ldots,n
\end{aligned}
$$
