...
$$
\begin{aligned}
&\mathbb{E}\bigl[\max(X^{2}, Y^{2})\bigr]\\[0.45em]
&\quad =\mathbb{E}\Bigl[\frac{1}{\,2\,}\bigl(\lvert X^{2}+Y^{2}\rvert+\lvert X^{2}-Y^{2}\rvert\bigr)\Bigr]\\[0.45em]
&\quad =\frac{1}{\,2\,}\mathbb{E}\bigl[\lvert X^{2}+Y^{2}\rvert\bigr]+\frac{1}{\,2\,}\mathbb{E}\bigl[\lvert X^{2}-Y^{2}\rvert\bigr]\\[0.45em]
&\quad =\frac{1}{\,2\,}\mathbb{E}(X^{2}+Y^{2})+\frac{1}{\,2\,}\mathbb{E}\bigl[\lvert (X+Y)(X-Y)\rvert\bigr]
\end{aligned}
$$
...
$$
\begin{aligned}
&\Bigl(\mathbb{E}\bigl[\lvert (X+Y)(X-Y)\rvert\bigr]\Bigr)^{2}\\[0.45em]
&\quad \leqslant\mathbb{E}\bigl[\lvert X+Y\rvert^{2}\bigr]\mathbb{E}\bigl[\lvert X-Y\rvert^{2}\bigr]\\[0.45em]
&\quad =\mathbb{E}\bigl[(X+Y)^{2}\bigr]\mathbb{E}\bigl[(X-Y)^{2}\bigr]
\end{aligned}
$$
...
\Bigl(\because\ \mathrm{Var}(X)=\mathrm{Var}(Y)=1\ \Longrightarrow\ \mathbb{E}(XY)=\frac{\mathbb{E}(XY)}{\sqrt{\mathrm{Var}(X)\mathrm{Var}(Y)}}=\rho\Bigr)
\end{gathered}
$$
...
$$
\begin{aligned}
&\mathbb{E}\bigl[\lvert (X+Y)(X-Y)\rvert\bigr]\\[0.45em]
&\quad \leqslant\sqrt{(2+2\rho)(2-2\rho)}=2\sqrt{1-\rho^{2}}
\end{aligned}
$$
...
\begin{aligned}
&\mathbb{E}\bigl[\max(X^{2}, Y^{2})\bigr]\\[0.45em]
&\quad =\frac{1}{\,2\,}\mathbb{E}(X^{2}+Y^{2})+\frac{1}{\,2\,}\mathbb{E}\bigl[\lvert (X+Y)(X-Y)\rvert\bigr]\\[0.45em]
&\quad \leqslant 1+\sqrt{1-\rho^{2}}
\end{aligned}
$$
...
\begin{aligned}
&\mathrm{Var}(\boldsymbol{Z})=\mathrm{Var}\Biggl(\begin{bmatrix} \cos\theta & \sin\theta\\ -\sin\theta & \cos\theta \end{bmatrix}\begin{bmatrix} X_1\\ X_2 \end{bmatrix}\Biggr)\\[0.45em]
&\quad =\begin{bmatrix} \cos\theta & \sin\theta\\ -\sin\theta & \cos\theta \end{bmatrix}\begin{bmatrix} \sigma_1^{2} & 0\\ 0 & \sigma_{2}^{2} \end{bmatrix}\begin{bmatrix} \cos\theta & \sin\theta\\ -\sin\theta & \cos\theta \end{bmatrix}^{\mathrm{T}}\\[0.45em]
&\quad =\begin{bmatrix} \cos^{2}\theta\sigma_1^{2}+\sin^{2}\theta\sigma_2^{2} & -\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2})\\ -\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2}) & \sin^{2}\theta\sigma_1^{2}+\cos^{2}\theta\sigma_2^{2} \end{bmatrix}
\end{aligned}
$$
...
&\quad =\begin{bmatrix} \sqrt{\cos^{2}\theta\sigma_1^{2}+\sin^{2}\theta\sigma_2^{2}} & 0\\ 0 & \sqrt{\sin^{2}\theta\sigma_1^{2}+\cos^{2}\theta\sigma_2^{2}} \end{bmatrix}
\end{aligned}
$$
...
$$
\begin{aligned}
&\mathbf{C}_{\sssig \boldsymbol{Z}}=\\[0.35em]
&\quad \mathbf{D}^{-1}\begin{bmatrix} \cos^{2}\theta\sigma_1^{2}+\sin^{2}\theta\sigma_2^{2} & -\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2})\\ -\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2}) & \sin^{2}\theta\sigma_1^{2}+\cos^{2}\theta\sigma_2^{2} \end{bmatrix}\mathbf{D}^{-1}\\[0.55em]
&\quad =\begin{bmatrix} 1 & \frac{-\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2})}{\sqrt{\begin{array}{c}(\cos^{2}\theta\sigma_1^{2}+\sin^{2}\theta\sigma_2^{2})\\ (\sin^{2}\theta\sigma_1^{2}+\cos^{2}\theta\sigma_2^{2})\end{array}}}\\[1.2em] \frac{-\cos\theta\sin\theta(\sigma_1^{2}-\sigma_2^{2})}{\sqrt{\begin{array}{c}(\cos^{2}\theta\sigma_1^{2}+\sin^{2}\theta\sigma_2^{2})\\ (\sin^{2}\theta\sigma_1^{2}+\cos^{2}\theta\sigma_2^{2})\end{array}}} & 1 \end{bmatrix}
\end{aligned}
$$
...
&\quad =\frac{\cos^{2}\theta\sin^{2}\theta(\sigma_1^{2}-\sigma_2^{2})^{2}}{\begin{array}{c}(\cos^{2}\theta\sin^{2}\theta\sigma_1^{4}+(\cos^{4}\theta+\sin^{4}\theta)\sigma_1^{2}\sigma_2^{2}\\ +\cos^{2}\theta\sin^{2}\theta\sigma_2^{4})\end{array}}
\end{aligned}
$$
...
$$
\begin{gathered}
1=(\sin^{2}\theta+\cos^{2}\theta)^{2}=\sin^{4}\theta+2\sin^{2}\theta\cos^{2}\theta+\cos^{4}\theta\\[0.45em]
\therefore\ \sin^{4}\theta+\cos^{4}\theta=1-2\sin^{2}\theta\cos^{2}\theta
\end{gathered}
$$
...
&\quad =\sin^{4}\theta+2\sin^{2}\theta\cos^{2}\theta+\cos^{4}\theta
\end{aligned}\\[0.45em]
\therefore\ \sin^{4}\theta+\cos^{4}\theta=1-2\sin^{2}\theta\cos^{2}\theta
\end{gathered}
$$
...
$$
\begin{gathered}
\sin^{2}(2\theta)=4\sin^{2}\theta\cos^{2}\theta\leqslant 1\\[0.45em]
\therefore\ 1-2\cos^{2}\theta\sin^{2}\theta\geqslant 2\cos^{2}\theta\sin^{2}\theta
\end{gathered}
$$
...
&\quad =\frac{\cos^{2}\theta\sin^{2}\theta(\sigma_1^{2}-\sigma_2^{2})^{2}}{\begin{array}{c}(\cos^{2}\theta\sin^{2}\theta\sigma_1^{4}+(1-2\cos^{2}\theta\sin^{2}\theta)\sigma_1^{2}\sigma_2^{2}\\ +\cos^{2}\theta\sin^{2}\theta\sigma_2^{4})\end{array}}\\[0.45em]
&\quad \leqslant\frac{\cos^{2}\theta\sin^{2}\theta(\sigma_1^{2}-\sigma_2^{2})^{2}}{\begin{array}{c}(\cos^{2}\theta\sin^{2}\theta\sigma_1^{4}+2\sin^{2}\theta\cos^{2}\theta\sigma_1^{2}\sigma_2^{2}\\ +\cos^{2}\theta\sin^{2}\theta\sigma_2^{4})\end{array}}\\[0.45em]
&\quad =\frac{(\sigma_1^{2}-\sigma_2^{2})^{2}}{(\sigma_1^{4}+2\sigma_1^{2}\sigma_2^{2}+\sigma_2^{4})}=\biggl(\frac{\sigma_1^{2}-\sigma_2^{2}}{\sigma_1^{2}+\sigma_2^{2}}\biggr)^{2}
\end{aligned}
$$
...
&\quad =\frac{\operatorname{Cov}(X_1+X_2, X_2+X_3)}{\sqrt{\mathrm{Var}(X_1+X_2)\mathrm{Var}(X_2+X_3)}}\\[0.45em]
&\quad =\frac{\sigma^{2}}{\sqrt{2\sigma^{2}\cdot 2\sigma^{2}}}=\frac{1}{\,2\,}
\end{aligned}
$$
...
\begin{aligned}
&\mathrm{Var}(\mathbf{A}\boldsymbol{X})=\mathbf{A}\,\mathrm{Var}(\boldsymbol{X})\,\mathbf{A}^{\mathrm{T}}\\[0.45em]
&\quad =\begin{bmatrix} 1 & 1 & 0\\ 0 & 1 & 1 \end{bmatrix}\begin{bmatrix} \sigma^{2} & 0 & 0\\ 0 & \sigma^{2} & 0\\ 0 & 0 & \sigma^{2} \end{bmatrix}\begin{bmatrix} 1 & 1 & 0\\ 0 & 1 & 1 \end{bmatrix}^{\mathrm{T}}\\[0.45em]
&\quad =\begin{bmatrix} 2\sigma^{2} & \sigma^{2}\\ \sigma^{2} & 2\sigma^{2} \end{bmatrix}
\end{aligned}
$$
...
&\quad =\begin{bmatrix} 1 & \frac{1}{\,2\,}\\[0.35em] \frac{1}{\,2\,} & 1 \end{bmatrix}
\end{aligned}
$$
...
$$
\begin{aligned}
&\operatorname{Cov}(X_1+X_2, X_2+X_3)\\[0.45em]
&\quad =\operatorname{Cov}\Bigl(\begin{bmatrix} 1 & 1 & 0 \end{bmatrix}\boldsymbol{X},\ \begin{bmatrix} 0 & 1 & 1 \end{bmatrix}\boldsymbol{X}\Bigr)\\[0.45em]
&\quad =\begin{bmatrix} 1 & 1 & 0 \end{bmatrix}\begin{bmatrix} \sigma^{2} & 0 & 0\\ 0 & \sigma^{2} & 0\\ 0 & 0 & \sigma^{2} \end{bmatrix}\begin{bmatrix} 0\\ 1\\ 1 \end{bmatrix}=\sigma^{2}
\end{aligned}
$$
