...
$$
\begin{aligned}
&\mathbb{E}\Biggl[kX^{k-1}+\binom{k}{2}X^{k-2}+\cdots+1\Biggr]\\[0.45em]
&=\frac{\,(n+1)^{k}-1\,}{n}
\end{aligned}
$$
...
&=\sum_{j=1}^{k}\binom{k}{j}1^{j}X^{k-j}\\[0.45em]
&=\sum_{j=0}^{k}\binom{k}{j}1^{j}X^{k-j}-X^{k}\\[0.45em]
&=(1+X)^{k}-X^{k}
\end{aligned}
$$
...
\begin{aligned}
&\mathbb{E}\Biggl[kX^{k-1}+\binom{k}{2}X^{k-2}+\cdots+1\Biggr]\\[0.45em]
&=\mathbb{E}\bigl[(1+X)^{k}-X^{k}\bigr]\\[0.45em]
&=\mathbb{E}\bigl[(1+X)^{k}\bigr]-\mathbb{E}(X^{k})
\end{aligned}
$$
...
\begin{aligned}
&\mathbb{E}\Biggl[kX^{k-1}+\binom{k}{2}X^{k-2}+\cdots+1\Biggr]\\[0.45em]
&=\mathbb{E}\bigl[(1+X)^{k}\bigr]-\mathbb{E}(X^{k})\\[0.45em]
&=\frac{1}{\,n\,}\bigl[2^{k}+3^{k}+\cdots+(1+n)^{k}\bigr]\\[0.2em]
&\qquad\quad-\frac{1}{\,n\,}\bigl(1^{k}+2^{k}+\cdots+n^{k}\bigr)\\[0.45em]
&=\frac{\,(n+1)^{k}-1\,}{n}
\end{aligned}
$$
...
&=\mathbb{E}\Bigl[\bigl[X+(-\mu_{\sssig X})\bigr]^{r}\Bigr]\\[0.45em]
&=\mathbb{E}\left[\sum_{k=0}^{r}\binom{r}{k}X^{k}\,(-\mu_{\sssig X})^{r-k}\right]\\[0.45em]
&=\sum_{k=0}^{r}\binom{r}{k}\mathbb{E}(X^{k})\,(-\mu_{\sssig X})^{r-k}\\[0.45em]
&=\sum_{k=0}^{r}\binom{r}{k}\mu_{\sssig k}^{\prime}\,(-\mu_{\sssig X})^{r-k}
\end{aligned}
$$
...
&=\mathbb{E}\Bigl[\bigl[(X-\mu_{\sssig X})+\mu_{\sssig X}\bigr]^{r}\Bigr]\\[0.45em]
&=\mathbb{E}\left[\sum_{k=0}^{r}\binom{r}{k}(X-\mu_{\sssig X})^{k}\,\mu_{\sssig X}^{r-k}\right]\\[0.45em]
&=\sum_{k=0}^{r}\binom{r}{k}\mathbb{E}\bigl[(X-\mu_{\sssig X})^{k}\bigr]\,\mu_{\sssig X}^{r-k}\\[0.45em]
&=\sum_{k=0}^{r}\binom{r}{k}\mu_{\sssig k}\,\mu_{\sssig X}^{r-k}
\end{aligned}
$$
...
&=\int_{1}^{\infty}x\,f_{\sssig X}(x)\,dx\\[0.45em]
&=\int_{1}^{\infty}x\cdot\frac{2}{\,x^{3}\,}\,dx=2<\infty
\end{aligned}
$$
...
&=\int_{1}^{\infty}x^{2}f_{\sssig X}(x)\,dx\\[0.45em]
&=\int_{1}^{\infty}x^{2}\cdot\frac{2}{\,x^{3}\,}\,dx=\infty
\end{aligned}
$$
