...
$$
\begin{aligned}
\mathbb{P}(&U_1\leqslant u,N=n) =\mathbb{P}(U_{n-1}<U_{n-2}<\cdots<U_{1}\leqslant u,\\[0.2em]
...
\begin{aligned}
\mathbb{P}(&U_{n}<U_{n-1}<U_{n-2}<\cdots<U_{1}\leqslant u)\\[0.45em]
&=\int_{0}^{u}\int_{0}^{u_1}\int_{0}^{u_2}\cdots\int_{0}^{u_{n-1}}\\[0.2em]
&\qquad\qquad 1\,du_{n}\,du_{n-1}\cdots\,du_{1}\\[0.45em]
&=\int_{0}^{u}\int_{0}^{u_1}\int_{0}^{u_2}\cdots\int_{0}^{u_{n-2}}\\[0.2em]
&\qquad\qquad u_{n-1}\,du_{n-1}\,du_{n-2}\cdots\,du_{1}\\[0.45em]
&=\cdots=\int_{0}^{u}\frac{1}{\,(n-1)!\,}u_1^{n-1}\,du_{1}\\[0.45em]
&=\frac{\,u^n\,}{\,n!\,},\quad 0<u\leqslant 1
\end{aligned}
$$
...
$$
\begin{aligned}
\mathbb{P}(U_1\leqslant u,\ N\ \text{偶數})&=\sum_{k=1}^{\infty}\mathbb{P}(U_1\leqslant u,N=2k)\\[0.45em]
&=\sum_{k=1}^{\infty}\left[\frac{\,u^{2k-1}\,}{\,(2k-1)!\,}-\frac{\,u^{2k}\,}{\,(2k)!\,}\right]\\[0.45em]
&=\frac{\,u\,}{1!}-\frac{\,u^2\,}{2!}+\frac{\,u^3\,}{3!}-\frac{\,u^4\,}{4!}+\cdots\\[0.45em]
&=1-\biggl(1-\frac{\,u\,}{1!}+\frac{\,u^2\,}{2!}\\[0.2em]
...
$$
\begin{aligned}
\mathbb{P}(N=n)&=\mathbb{P}(U_1+\cdots+U_{n-1}\leqslant 1,\\[0.2em]
&\qquad\qquad U_1+\cdots+U_{n-1}+U_n>1)\\[0.45em]
&=\mathbb{P}(U_1+\cdots+U_{n-1}\leqslant 1)\\[0.45em]
...
$$
\begin{aligned}
\mathbb{P}(&U_1+\cdots+U_{n-1}+U_n\leqslant 1) =\int_{0}^{1}\int_{0}^{1-u_1}\int_{0}^{1-u_1-u_{2}}\cdots\\[0.2em]
&\qquad\quad \int_{0}^{1-u_1-\cdots-u_{n-1}}1\,du_{n}\,du_{n-1}\cdots\,du_{1}\\[0.45em]
&=\int_{0}^{1}\int_{0}^{1-u_1}\int_{0}^{1-u_1-u_{2}}\cdots\\[0.2em]
&\qquad\quad \int_{0}^{1-u_1-\cdots-u_{n-2}}(1-u_1-\cdots-u_{n-1})\\[0.2em]
&\qquad\qquad du_{n-1}\,du_{n-2}\cdots\,du_{1}\\[0.45em]
&=\cdots=\int_{0}^{1}\frac{1}{\,(n-1)!\,}(1-u_1)^{n-1}\,du_{1}\\[0.45em]
&=\frac{\,1\,}{\,n!\,}
\end{aligned}
$$
