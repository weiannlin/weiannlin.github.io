...
topic: 18
order: 418
permalink: /teaching-topics/ch4-p18-candidate/
date: 2026-08-12
published: false
...
&\quad =\mathbb{P}\biggl(\frac{X-600}{2}>\frac{605-600}{2}\biggr)\\[0.3em]
&\qquad +\mathbb{P}\biggl(\frac{X-600}{2}<\frac{595-600}{2}\biggr)\\[0.3em]
&\quad =\mathbb{P}(Z>2.5)+\mathbb{P}(Z<-2.5)\\[0.3em]
&\quad =0.0062+0.0062=0.0124
\end{aligned}
$$
...
$$
\begin{aligned}
\Longrightarrow\ \mathbb{P}(X>605)+\mathbb{P}(X<595)&=\mathbb{P}\biggl(Z>\frac{605-600}{\sigma}\biggr)\\[0.45em]
...
$$
\begin{aligned}
&\Longrightarrow\ \mathbb{P}(X>605)+\mathbb{P}(X<595)\\[0.3em]
&\quad =\mathbb{P}\biggl(Z>\frac{605-600}{\sigma}\biggr)\\[0.3em]
...
$$
\Longrightarrow\ \frac{5}{\,\sigma\,}=2.575\ \ \therefore\ \sigma=1.9418
$$
...
$$
\begin{aligned}
&\mathbb{P}(X<0.05)\\[0.3em]
&\quad =\mathbb{P}\biggl(Z<\frac{\,0.05-0.08\,}{0.015}=-2\biggr)\\[0.3em]
&\quad =0.0228
\end{aligned}
$$
...
&\quad =\mathbb{P}\biggl(Z>\frac{0-0.015}{\sqrt{0.000625}}\biggr)\\[0.3em]
&\quad =\mathbb{P}(Z>-0.6)=0.7257
\end{aligned}
$$
...
&\quad =\frac{\begin{gathered}\mathbb{P}\bigl(\,\lbrace0.05<X\leqslant0.10\rbrace\\[0.15em] \cap\ \lbrace0.05<Y\leqslant0.10\rbrace\,\bigr)\end{gathered}}{\mathbb{P}(\,0.05<X\leqslant0.10\,)}\\[0.3em]
&\quad =\frac{\begin{gathered}\mathbb{P}(\,0.05<X\leqslant0.10\,)\\[0.15em] \times\ \mathbb{P}(\,0.05<Y\leqslant0.10\,)\end{gathered}}{\mathbb{P}(\,0.05<X\leqslant0.10\,)}\\[0.3em]
&\qquad\qquad (\,\because\ X\indep Y\,)\\[0.3em]
&\quad =\mathbb{P}(\,0.05<Y\leqslant0.10\,)\\[0.3em]
&\quad =\mathbb{P}\biggl(\frac{\,0.05-0.095\,}{0.02}<Z\\[0.2em]
&\qquad\qquad <\frac{\,0.1-0.095\,}{0.02}\biggr)\\[0.3em]
&\quad =\mathbb{P}(-2.25<Z<0.25)=0.5865
\end{aligned}
$$
...
&\quad =\mathbb{P}\biggl(\frac{\,1-2\,}{\sqrt{4}}<Z\leqslant\frac{\,4-2\,}{\sqrt{4}}\biggr)\\[0.3em]
&\quad =\mathbb{P}(-0.5<Z\leqslant1)\\[0.3em]
&\quad =\mathbb{P}(Z\leqslant1)-\mathbb{P}(Z\leqslant-0.5)\\[0.3em]
&\quad =\Phi(1)-\Phi(-0.5)
\end{aligned}
$$
...
&\quad =\int_{-\infty}^{0}f_{\sssig Z}(z)\,dz+\int_{0}^{\infty}f_{\sssig Z}(z)\,dz\\[0.3em]
&\quad =\int_{-\infty}^{0}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.2em]
&\qquad +\int_{0}^{\infty}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.3em]
&\quad =\int_{\infty}^{0}2\,\phi(-t)\Phi(-\lambda t)\,d(-t)\\[0.2em]
&\qquad +\int_{0}^{\infty}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.2em]
&\qquad\qquad (\,\text{令}\ z=-t\,)\\[0.3em]
&\quad =\int^{\infty}_{0}2\,\phi(t)\bigl[1-\Phi(\lambda t)\bigr]\,dt\\[0.2em]
&\qquad +\int_{0}^{\infty}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.3em]
&\quad =\int_{0}^{\infty}2\,\phi(z)\bigl[\bigl(1-\Phi(\lambda z)\bigr)\\[0.2em]
&\qquad\qquad +\Phi(\lambda z)\bigr]\,dz\\[0.3em]
&\quad =2\int_{0}^{\infty}\phi(z)\,dz=2\times\frac{1}{\,2\,}=1
\end{aligned}
$$
...
&\quad +\int_{0}^{\sqrt{y}}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.3em]
&=\int_{\sqrt{y}}^{0}2\,\phi(-t)\Phi(-\lambda t)\,d(-t)\\[0.2em]
&\quad +\int_{0}^{\sqrt{y}}2\,\phi(z)\Phi(\lambda z)\,dz\\[0.2em]
...
$$
[\,Z\geqslant0\,]\quad Y=Z^{2}\ \Longrightarrow\ Z=\sqrt{Y}\ \text{且}\ \mathbf{J}=\frac{\,d\,z\,}{\,d\,y\,}=\frac{1}{\,\sqrt{2y}\,}
$$
...
$$
\begin{gathered}
[\,Z\geqslant0\,]\quad Y=Z^{2}\ \Longrightarrow\ Z=\sqrt{Y}\\[0.35em]
\text{且}\ \mathbf{J}=\frac{\,d\,z\,}{\,d\,y\,}=\frac{1}{\,\sqrt{2y}\,}
\end{gathered}
$$
...
$$
[\,Z<0\,]\quad Y=Z^{2}\ \Longrightarrow\ Z=-\sqrt{Y}\ \text{且}\ \mathbf{J}=\frac{\,d\,z\,}{\,d\,y\,}=\frac{-1}{\,\sqrt{2y}\,}
$$
...
$$
\begin{gathered}
[\,Z<0\,]\quad Y=Z^{2}\ \Longrightarrow\ Z=-\sqrt{Y}\\[0.35em]
\text{且}\ \mathbf{J}=\frac{\,d\,z\,}{\,d\,y\,}=\frac{-1}{\,\sqrt{2y}\,}
\end{gathered}
$$
...
[Example 4.45](#ex-normal-prob-2) 的第一小題只是單一常態變數的機率計算。第二小題要比較兩支股票的年報酬，作法是把 $\mathbb{P}(Y>X)$ 改寫成 $\mathbb{P}(Y-X>0)$ 這個形式，再由[上一篇](/teaching-topics/ch4-p17-candidate/)的線性組合可加性得知 $Y-X$ 仍為常態分配，其期望值為兩者的期望值之差、變異數為兩者的變異數之和。第三小題則先以條件機率的定義展開，再由獨立性把分子拆成兩個機率相乘，與分母約去之後只剩下 B 公司的那一項。[Example 4.46](#ex-normal-prob-3) 要求以 $\Phi(\cdot)$ 表達答案，因此標準化之後把結果留在 $\Phi(1)-\Phi(-0.5)$ 這個差，不再換算為數值。
