...
\boxed{
\begin{gathered}
X\indep Y\quad\Longrightarrow\quad\mathbb{E}(Y\mid X)=\mathbb{E}(Y)\ \bigl(\text{或 }\mathbb{E}(X\mid Y)=\mathbb{E}(X)\bigr)\\[0.45em]
...
&\quad =0\cdot 0.5+1\cdot 0.5=0.5\\[0.9em]
...
&\quad =(-1)\cdot 0.25+0\cdot 0.5+1\cdot 0.25=0\\[0.9em]
